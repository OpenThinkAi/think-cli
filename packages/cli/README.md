...
Each removed flag or command exits non-zero with a one-line pointer to its replacement rather than being quietly ignored or reported as a generic unknown command.
